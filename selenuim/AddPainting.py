...
time.sleep(3)
assert driver.find_element(By.XPATH,"//button[@class='button button5']").is_displayed(), "The click not display"
print("can't add painting")


# Add painting without title:
driver.get("http://127.0.0.1:5000/")
driver.find_element(By.XPATH,"//img[@src='../static/image112.png']").click()
driver.find_element(By.NAME,'filename').send_keys("C:/Users/amnes/OneDrive/Desktop/painting.jpg")
# driver.find_element(By.NAME,'painting_title').send_keys("The Most Famous Paintings in the World")
...
# Add painting without decription:
driver.get("http://127.0.0.1:5000/")
driver.find_element(By.XPATH,"//img[@src='../static/image112.png']").click()
driver.find_element(By.NAME,'filename').send_keys("C:/Users/amnes/OneDrive/Desktop/painting.jpg")
driver.find_element(By.NAME,'painting_title').send_keys("The Most Famous Paintings in the World")
...
# Add painting without current location:
driver.get("http://127.0.0.1:5000/")
driver.find_element(By.XPATH,"//img[@src='../static/image112.png']").click()
driver.find_element(By.NAME,'filename').send_keys("C:/Users/amnes/OneDrive/Desktop/painting.jpg")
driver.find_element(By.NAME,'painting_title').send_keys("The Most Famous Paintings in the World")
...
# Add Painting with random picture:
driver.get("http://127.0.0.1:5000/")
driver.find_element(By.XPATH,"//img[@src='../static/image112.png']").click()
driver.find_element(By.NAME,'filename').send_keys("C:/Users/amnes/OneDrive/Desktop/painting.jpg")
driver.find_element(By.NAME,'painting_title').send_keys("The Most Famous Paintings in the World")
